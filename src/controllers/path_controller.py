...
"""
Este módulo fornece classes para gerenciar e manipular arquivos e pastas, com foco na
filtragem de arquivos HTML e criação de PDFs a partir de listas de links extraídos desses arquivos.

Classes:
    GerenciadorCaminhos: Gerencia a filtragem e manipulação de caminhos e arquivos HTML.
    HTMLParser: Extrai e organiza links de arquivos HTML e gera PDFs com listas de links formatadas.
"""
...
from views.path_logger import CustomLogger
from models.path_models import FilePathModel, FolderPathModel
